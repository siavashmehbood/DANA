...
class AdminPersianLocalizationTests(TestCase):
    def test_management_apps_models_and_fields_have_persian_labels(self):
        ...
        checks=[('accounts','User','phone','شماره تلفن'),('books','Book','price','قیمت'),('shop','Payment','authority','شناسه درگاه'),('reader','ReadingProgress','progress','پیشرفت'),('gamification','XPEvent','reason','دلیل'),('analytics','Event','metadata','فراداده'),('notifications','Notification','read_at','زمان خواندن'),('support','Ticket','assigned_to','ارجاع‌شده به'),('articles','Article','translation_status','وضعیت ترجمه'),('articles','Article','translation_quality','کیفیت ترجمه'),('accounts','User','is_staff','دسترسی مدیریت'),('shop','Payment','authority','شناسه درگاه'),('support','Ticket','priority','اولویت'),('gamification','PointLedger','point_type','نوع امتیاز'),('reader','AudioProgress','position_seconds','موقعیت پخش')]
