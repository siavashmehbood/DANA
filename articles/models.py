...
class Article(models.Model):
    ...
    class Meta:
        ...
        indexes = [models.Index(fields=['year']), models.Index(fields=['published']), models.Index(fields=['translation_status']), models.Index(fields=['source_provider','external_id'], name='articles_ar_source__2c663f_idx')]
